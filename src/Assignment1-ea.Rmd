...
```{r, fig.cap = "**Figure 1**. (A) total mountain yellow-legged frog (*Rana muscosa*) count each year across all bodies of water, by life stage excluding ‘EggMass’ level (B) total counts of combined adult and subadult *Rana muscosa* observed in five lakes with the greatest total observed counts", fig.width= 10, echo = FALSE, error = FALSE, warning=FALSE, message=FALSE}
